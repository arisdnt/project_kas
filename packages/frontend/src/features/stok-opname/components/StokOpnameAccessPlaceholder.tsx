...
interface StokOpnameAccessPlaceholderProps {
  className?: string
}

export function StokOpnameAccessPlaceholder({ className }: StokOpnameAccessPlaceholderProps) {
  return (
    <div className={cn("text-center space-y-4 p-6 bg-gray-50 rounded-lg border border-gray-200", className)}>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-600 max-w-md mx-auto">
          Anda tidak memiliki akses untuk mengelola stok opname.
