      ...
      <TableCell colSpan={6} className="py-16 text-center text-sm text-slate-500">
        <div className="mx-auto flex max-w-md flex-col items-center gap-3">
          ...
          <div className="space-y-1">
            <p className="text-sm font-semibold text-slate-700">Tidak ada brand sesuai filter</p>
            <p className="text-[12px] text-slate-500">
              Sesuaikan kata kunci atau bersihkan filter untuk melihat data brand lainnya.
            </p>
          </div>
        </div>
      </TableCell>
