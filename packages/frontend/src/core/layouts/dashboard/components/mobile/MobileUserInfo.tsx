    ...
    <div className="border-t border-gray-100 pt-4 mt-4">
      <div className="px-3 py-3 bg-gray-50 rounded-lg">
        ...
        <div className="mt-3 grid grid-cols-1 gap-2">
          <Link to="/dashboard/profile" onClick={onClose} className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-gray-700 hover:bg-white rounded-md transition-colors">
            <Users className="h-4 w-4" />
            <span>Profil Saya</span>
          </Link>
          <Link to="/dashboard/profile/pengaturan" onClick={onClose} className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-gray-700 hover:bg-white rounded-md transition-colors">
