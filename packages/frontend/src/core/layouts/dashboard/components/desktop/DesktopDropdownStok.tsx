  ...
  const groups: GroupDef[] = [
    {
      ...
      items: [
        {
          name: 'Stok Opname',
          href: '/dashboard/stok-opname',
          description: 'Audit persediaan dan penyesuaian stok.',
          submenu: [
            { name: 'Buat Audit Baru', href: '/dashboard/stok-opname?new=1' },
            { name: 'Riwayat Audit', href: '/dashboard/stok-opname?tab=riwayat' },
          ],
        },
        {
          name: 'Mutasi Stok',
          href: '/dashboard/mutasi-stok',
          description: 'Pindahkan stok antar lokasi atau koreksi.',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: 'Daftar aset/inventaris dan statusnya.',
        },
      ],
    },
  ];
          ...
          {groups.map((group, gi) => (
            <div key={group.label}>
              ...
              {group.items.map((gitem) => {
                const iconFromBase = stokInventarisItems.find((i) => i.name === gitem.name)?.icon;
                const Icon = iconFromBase ?? Warehouse;
