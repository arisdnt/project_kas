...
create_supplier() {
    ...
    local json_data="{\"nama\": \"$supplier_name\", \"kontak_person\": \"$contact_person\", \"telepon\": \"$phone\", \"email\": \"$email\", \"alamat\": \"$address\", \"npwp\": \"$npwp\", \"bank_nama\": \"$bank_name\", \"bank_rekening\": \"$bank_account\", \"bank_atas_nama\": \"$bank_holder\", \"status\": \"aktif\"}"
